...
from app.api.endpoints import auth, quizzes, questions, answers, game_sessions, rooms, upload, quiz_rounds
...
api_router.include_router(quiz_rounds.router, prefix="/quiz-rounds", tags=["quiz-rounds"])
